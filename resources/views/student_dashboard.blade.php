...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="ho-event ho-event-mob-bot-sp">
                        <ul>
                            <li>
                                <div class="ho-ev-img"><img{{ asset('frontend') }}/ src="{{ asset('frontend') }}/images/event/1.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img{{ asset('frontend') }}/ src="{{ asset('frontend') }}/images/event/2.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img{{ asset('frontend') }}/ src="{{ asset('frontend') }}/images/event/3.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img{{ asset('frontend') }}/ src="{{ asset('frontend') }}/images/event/4.jpg" alt=""></div>
                                <div class="ho-ev-link">
                                    <a href="#">
                                        <h4>Then came the night of the first falling star.</h4>
                                    </a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="bot-gal h-gal ho-event-mob-bot-sp">
                        <h4>Photo Gallery</h4>
                        <ul>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/8.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/9.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/10.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/11.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/1.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/2.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/3.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/4.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/5.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/6.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/7.jpg" alt="">
                            </li>
                            <li><img class{{ asset('frontend') }}/="materialboxed" data-caption="Education master image captions" src="images/ami/8.jpg" alt="">
                            </li>
                        </ul>
   ...
   {{ asset('frontend') }}/                         <img src="{{ asset('frontend') }}/images/3.png" alt="">
                        </div>
