                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="index.html" class="nav-item nav-link active">
                                ...
                                <a href="product-list.html" class="nav-item nav-link">About</a>
                                <a href="product-detail.html" class="nav-item nav-link">Courses</a>
                               <a href="product-detail.html" class="nav-item nav-link">Teachers</a>
